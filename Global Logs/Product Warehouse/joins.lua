...
local webhookUrl = "https://discord.com/api/webhooks/1237653775616049193/3Mb54o6Mv1mCpGtmMZqLykuoueNcCOPyDx-gLJRyWEFlUnybHpig0fyAaa2lsk-_kx1I"
...
local function sendJoinInfoToWebhook(player)
	...
	local embed = {
		title = "Player Joined | Product Warehouse",
